...
public class Condition {
    ...
    public boolean evaluate(Path path) {
        ...
        if (entity.equals("stops")) {
            ...
            throw new IllegalArgumentException(StartTrainRouteSearch.getProperty("unknown_entity") + ": " + entity);
        }
        return rc;
    }

    /**
     * Constructs a Condition object that can be evaluated against a given Path later.
     *
    ...
    public Condition(String operator, int value, String entity) {
        ...
        if (this.operation == null) {
            throw new IllegalArgumentException(StartTrainRouteSearch.getProperty("unknown_operator") + ": " + operator);
        }
        this.value = value;
        this.entity = entity;
    }
